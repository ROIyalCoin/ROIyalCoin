Contributing to ROCO Core
============================

The ROCO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ROCO Core project, and is not to be
confused with overall ROCO Network Protocol consensus changes.

Whether a pull request is merged into ROCO Core rests with the project merge
...
Patches that change ROCO consensus rules are considerably more involved than
...
Where a patch set proposes to change the ROCO consensus, it must have been
...
The project leader is the release manager for each ROCO Core release.
