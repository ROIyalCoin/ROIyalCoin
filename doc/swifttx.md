...
* WebSocket: [https://github.com/ROCO-Core/insight-api-roco#web-socket-api](https://github.com/ROCO-Core/insight-api-roco#web-socket-api)
* API: [https://github.com/ROCO-Core/insight-api-roco#swifttx-transactions](https://github.com/ROCO-Core/insight-api-roco#swifttx-transactions)
...
By default, the ROCO Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ROCO Core daemon:
