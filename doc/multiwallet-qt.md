...
In order to support loading of multiple wallets in roco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is roco.cpp.
...
Changes to roco.cpp
----------------------
roco.cpp is the entry point into roco-qt, and as such, will require some minor modifications to provide hooks for
