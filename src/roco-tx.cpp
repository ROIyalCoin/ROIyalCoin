...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ROIyalCoin Core roco-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  roco-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ROCO transaction") + "\n" +
                               "  roco-tx [options] -create [commands]   " + _("Create hex-encoded ROCO transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ROCO transaction
