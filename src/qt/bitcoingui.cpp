...
QFontDatabase::addApplicationFont(":/fonts/roco_font");

QString windowTitle = tr("ROIyalCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ROIyalCoin Wallet"), this);
    aboutAction->setStatusTip(tr("Show information about ROIyalCoin Wallet"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ROIyalCoin Wallet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ROCO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ROCO addresses"));
    ...
    openAction->setStatusTip(tr("Open a ROCO: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ROIyalCoin Wallet help message to get a list with possible ROCO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ROIyalCoin Wallet client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ROIyalCoin network", "", count));
}
...
{
    QString strTitle = tr("ROIyalCoin Wallet"); // default title
    ...
    // Append title to "ROIyalCoin Wallet - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
