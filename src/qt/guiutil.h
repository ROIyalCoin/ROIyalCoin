...
/** Utility functions used by the ROIyalCoin Wallet Qt UI.
 */
namespace GUIUtil
{
...
// Render ROIyalCoin addresses in monospace font
...
// Parse "roco:" URI into recipient object, return true on successful parsing
