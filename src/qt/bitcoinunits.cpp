...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ROCO);
   // unitlist.append(mROCO);
   // unitlist.append(uROCO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case ROCO:
        return QString("roco");
    case mROCO:
        return QString("mroco");
    case uROCO:
        return QString::fromUtf8("uroco");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case ROCO:
            return QString("tROCO");
        case mROCO:
            return QString("mtROCO");
        case uROCO:
            return QString::fromUtf8("μtROCO");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ROCO:
            return QString("ROCO");
        case mROCO:
            return QString("Milli-ROCO (1 / 1" THIN_SP_UTF8 "000)");
        case uROCO:
            return QString("Micro-ROCO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case ROCO:
            return QString("TestROCOs");
        case mROCO:
            return QString("Milli-TestROCOs (1 / 1" THIN_SP_UTF8 "000)");
        case uROCO:
            return QString("Micro-TestROCOs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
