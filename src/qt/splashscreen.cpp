...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("ROCO Wallet");
    ...
    QString copyrightTextROCO = QChar(0xA9) + QString(" 2018-2020 ").arg(COPYRIGHT_YEAR) + QString(tr("The ROIyalcoin developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextROCO);
