...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the ROCO money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all ROCO specific functionality (Masternodes, SwiftX) (0-1, default: %u)"), 0));
