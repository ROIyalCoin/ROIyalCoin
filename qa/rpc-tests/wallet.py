...
#   c) node1 mines 32 blocks, so now node 0 has 60001roco, node 1 has 4250roco, node2 has none.
#   d) node0 sends 601 roco to node2, in two transactions (301 roco, then 300 roco).
