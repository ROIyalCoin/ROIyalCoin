...
RESOURCES += src/qt/roco.qrc src/qt/roco_locale.qrc

TRANSLATIONS += src/qt/locale/roco_bg.ts \
                src/qt/locale/roco_de.ts \
                src/qt/locale/roco_en.ts \
                src/qt/locale/roco_es.ts \
                src/qt/locale/roco_fi.ts \
                src/qt/locale/roco_fr.ts \
                src/qt/locale/roco_it.ts \
                src/qt/locale/roco_ja.ts \
                src/qt/locale/roco_pl.ts \
                src/qt/locale/roco_pt.ts \
                src/qt/locale/roco_ru.ts \
                src/qt/locale/roco_sk.ts \
                src/qt/locale/roco_sv.ts \
                src/qt/locale/roco_vi.ts \
                src/qt/locale/roco_zh_CN.ts \
                src/qt/locale/roco_zh_TW.ts
